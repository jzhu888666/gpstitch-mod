...
(function () {
    ...
    const zh = {
        ...
        'Tasks': '任务',
        'Task Manager': '任务管理',
        'All render jobs share one managed queue': '所有渲染任务共用同一个任务队列',
        'Concurrency': '并发数',
        'Render concurrency': '渲染并发数',
        'Clear Finished': '清理已结束',
        'Remove finished tasks': '移除已结束任务',
        'No finished tasks to remove': '没有可移除的已结束任务',
        'Remove completed, failed, and cancelled tasks from Task Manager?': '确定要从任务管理器移除成功、失败和已取消的任务吗？',
        'tasks removed': '个任务已移除',
        'Failed to remove tasks': '移除任务失败',
        'Failed to update concurrency': '更新并发数失败',
        'Tasks refreshed': '任务已刷新',
        'No render tasks yet': '暂无渲染任务',
        'Start a render or batch render to see it here.': '启动单个渲染或批量渲染后会显示在这里。',
        'Select a task': '选择一个任务',
        'Task logs and render details will appear here.': '任务日志和渲染详情会显示在这里。',
        'Single render': '单个渲染',
        'tasks': '任务',
        'completed': '已完成',
        'Cancel Batch': '取消批次',
        'Cancel this render task?': '确定要取消这个渲染任务吗？',
        'Cancel all pending and running tasks in this batch?': '确定要取消这个批次中所有等待和运行中的任务吗？',
        'Task cancelled': '任务已取消',
        'tasks cancelled': '个任务已取消',
        'Failed to load tasks': '加载任务失败',
        'Failed to cancel batch': '取消批次失败',
        'Files': '文件',
        'Widgets': '组件',
        'Search widgets...': '搜索组件...',
        'Layout:': '布局:',
        ...
        'Select GPS Folder': '选择 GPS 目录',
        'Clear Folders': '清空目录',
        'Include subfolders': '包含子目录',
        'Shutdown after render completes': '渲染完成后关机',
        'Shutdown after batch completes': '批量完成后关机',
        'Shutdown when all tasks finish': '所有任务完成后关机',
        'Shutdown after all tasks finish': '所有任务完成后关机',
        'Shutdown is only supported on Windows': '仅 Windows 支持关机',
        'Failed to update shutdown setting': '更新关机设置失败',
        'Windows only. Runs only after the selected render task succeeds.': '仅 Windows 可用。只会在当前渲染任务成功后执行。',
        'Windows only. Runs only if every job in this batch succeeds.': '仅 Windows 可用。只会在本批次全部任务成功后执行。',
        'Shutdown': '关机',
        'Retry': '重试',
        'Retry Failed': '重试失败任务',
        ...
        'Retry selected failed tasks': '重试选中的失败任务',
        'Select failed tasks to retry': '选择失败任务后重试',
        'Cancel selected queued or running tasks': '取消选中的等待或运行任务',
        'Select queued or running tasks to cancel': '选择等待或运行任务后取消',
        'Retry selected failed tasks?': '确定要重试选中的失败任务吗？',
        'Cancel selected queued or running tasks?': '确定要取消选中的等待或运行任务吗？',
        'Failed to retry tasks': '重试任务失败',
        'Failed to cancel selected tasks': '取消选中任务失败',
        'tasks retried': '个任务已重试',
        'Enabled': '已启用',
        'Disabled': '未启用',
